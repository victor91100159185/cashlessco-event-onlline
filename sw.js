...
const CACHE_NAME = 'cashless-co-v3';
const APP_SHELL = ['./index.html', './manifest.json', './icon-96.png', './icon-192.png', './icon-512.png', './icon-1024.png', './icon-maskable-1024.png', './apple-touch-icon.png'];
